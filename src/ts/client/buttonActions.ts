...
const actionActions = [
	actionButtonAction('boop', 'Тиць'),
	actionButtonAction('down', 'Сісти / Приземлитися'),
	actionButtonAction('up', 'Встати / Злетіти'),
	actionButtonAction('turn-head', 'Повернути голову'),
	actionButtonAction('sneeze', 'Чихнути', Action.Sneeze),
	actionButtonAction('sleep', 'Спати', Action.Sleep),
	actionButtonAction('yawn', 'Позіхати', Action.Yawn),
	actionButtonAction('love', 'Сердечки', Action.Love),
	actionButtonAction('laugh', 'Сміятися', Action.Laugh),
	actionButtonAction('blush', 'Червоніти', Action.Blush),
	actionButtonAction('drop', 'Кинути предмет', Action.Drop),
	actionButtonAction('drop-toy', 'Зняти іграшку', Action.DropToy),
	actionButtonAction('magic', 'Магія', Action.Magic),
	actionButtonAction('switch-tool', 'Інструменти', Action.SwitchTool),
	actionButtonAction('switch-entity', 'Гортати предмети'),
	actionButtonAction('switch-entity-rev', 'Гортати предмети (назад)'),
	actionButtonAction('switch-tile', 'Гортати плитки'),
];
